...
public class DatabaseJTableTest extends JFrame 
{
  ...
  public DatabaseJTableTest() 
  {
    ...
    p1.add(new JLabel("jdbc:mysql://localhost/javabook"));
  ...
  {
    DatabaseJTableTest tt = new DatabaseJTableTest();
    tt.setVisible(true);
  }
}
